...
```bash
$ git clone git@github.com:username/calendar.git
```

This will clone your fork to your current path in a directory named `calendar`.
...
```bash
$ cd calendar
$ git remote add upstream git@github.com:ibm-js/calendar.git
$ git fetch upstream
```
