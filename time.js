define([
	...
	"dojo/date/stamp"
], function (lang, date, cldr, stamp) {


	var time = {
		// summary:
		//		Advanced date manipulation utilities.
		newDate: function (obj, DateClassObj) {
			// summary:
		...
		floorToDay: function (d, reuse, dateClassObj) {
			// summary:
		...
		floorToMonth: function (d, reuse, dateClassObj) {
			// summary:
		...
		floorToWeek: function (d, dateClassObj, dateModule, firstDayOfWeek, locale) {
			// summary:
			...
			var fd = firstDayOfWeek === undefined || firstDayOfWeek < 0 ? cldr.getFirstDayOfWeek(locale) :
				firstDayOfWeek;
			var day = d.getDay();
			if (day == fd) {
				return d;
		...
		floor: function (date, unit, steps, reuse, dateClassObj) {
			// summary:
		...
		isStartOfDay: function (d, dateClassObj, dateModule) {
			// summary:
		...
		isToday: function (d, DateClassObj) {
			// summary:
		...
		isOverlapping: function (cal, start1, end1, start2, end2, includeLimits) {
			// summary:
